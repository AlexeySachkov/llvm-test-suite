...
void check_read_data(s::vec<s::opencl::cl_float, 4> ReadData,
  ...
  if (((s::opencl::cl_int)Diff.x() <= 1 && (s::opencl::cl_int)Diff.x() >= -1) &&
      ((s::opencl::cl_int)Diff.y() <= 1 && (s::opencl::cl_int)Diff.y() >= -1) &&
      ((s::opencl::cl_int)Diff.z() <= 1 && (s::opencl::cl_int)Diff.z() >= -1) &&
      ((s::opencl::cl_int)Diff.w() <= 1 && (s::opencl::cl_int)Diff.w() >= -1))
    CorrectData = true;
...
void check_read_data(s::vec<s::opencl::cl_half, 4> ReadData,
  ...
  s::vec<s::opencl::cl_float, 4> ReadDatafloat = ReadData.convert<float>();
  s::vec<s::opencl::cl_float, 4> ExpectedColorfloat =
      ExpectedColor.convert<float>();
...
void check_half4(char *HostPtr) {
  ...
  // Calling only valid channel types with s::vec<s::opencl::cl_half, 4>.
  // s::image_channel_type::snorm_int8,
  write_type_order<s::vec<s::opencl::cl_half, 4>,
                   s::image_channel_type::snorm_int8>(
      HostPtr, s::image_channel_order::rgba,
      s::vec<s::opencl::cl_half, 4>(2, -2, 0.375f, 0));
  check_read_type_order<s::vec<s::opencl::cl_half, 4>,
                        s::image_channel_type::snorm_int8>(
      HostPtr, s::image_channel_order::rgba,
      s::vec<s::opencl::cl_half, 4>(
  ...
  write_type_order<s::vec<s::opencl::cl_half, 4>,
                   s::image_channel_type::unorm_int16>(
      HostPtr, s::image_channel_order::rgba,
      s::vec<s::opencl::cl_half, 4>(1, -1, 0.375f, 0));
  check_read_type_order<s::vec<s::opencl::cl_half, 4>,
                        s::image_channel_type::unorm_int16>(
      HostPtr, s::image_channel_order::rgba,
      s::vec<s::opencl::cl_half, 4>(
  ...
  write_type_order<s::vec<s::opencl::cl_half, 4>, s::image_channel_type::fp16>(
      HostPtr, s::image_channel_order::rgba,
      s::vec<s::opencl::cl_half, 4>(2, -2, 0.375f, 0));
  check_read_type_order<s::vec<s::opencl::cl_half, 4>,
                        s::image_channel_type::fp16>(
